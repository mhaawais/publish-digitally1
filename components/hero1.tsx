...
const Hero1 = () => {
  ...
  return (
    <section className="relative w-full h-screen overflow-hidden">
      ...
      {/* Torn Paper Top */}
      <div className="absolute top-0 left-0 w-full h-16 bg-[url('/assets/images/top.webp')] bg-repeat-x bg-top z-20" />

      {/* Torn Paper Bottom */}
      <div className="absolute bottom-0 left-0 w-full bg-[url('/assets/images/bottom.webp')] bg-repeat-x bg-bottom z-20" />
      ...
      <div className="relative z-30 flex flex-col justify-center items-start h-full px-6 md:px-16 max-w-4xl">
        <div className="bg-white/90 rounded-md p-6 md:p-10 shadow-lg backdrop-blur-sm">
          <h1 className="text-3xl md:text-4xl font-bold text-[#012A4A] mb-4 leading-tight">
            <span className="block">Professional Native Book Writers –</span>
            <span className="block">Expert Ghostwriting, Editing And</span>
          ...
          <button
            ...
            className="mt-4 bg-[#0077b6] text-white px-6 py-3 rounded-md font-semibold hover:bg-[#023e8a] transition-all shadow-md"
          >
            Get Started
          </button>
        </div>
