    ...
    <div className="absolute inset-0 bg-[#f2fbff]/30 z-0"></div>
      ...
      <div className="relative py-10 px-4 lg:px-20">
        <div className="relative z-10 max-w-7xl mx-auto text-center">
          <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold text-[#0a1a2f] drop-shadow-md">
            Our Publications
          </h2>
          <p className="mt-4 text-[#0a1a2f] max-w-3xl mx-auto text-base sm:text-lg drop-shadow-sm font-semibold">
            Pick any of the books published by us, and you will be mesmerized by it.
            From fiction to non-fiction, our top book publishing agency publishes captivating and inspiring books of modern high-quality.
          </p>
          ...
          <div className="mt-10 grid grid-cols-2 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-6 gap-6">
            {bookImages.map((src, index) => (
              <div key={index} className="rounded-lg overflow-hidden shadow-lg hover:scale-105 transition-transform duration-300 bg-white">
                <Image
                  src={src}
                  alt={`Book ${index + 1}`}
                  width={300}
